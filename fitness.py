...
def bmicalculator():
    ...
    credit = tk.Label(root, text="Made by :Abhishek Mohanty",
...
def bmrcalculator():
    ...
    credit = tk.Label(boot, text="Made by :Abhishek Mohanty",
                      font=("bebas", 6), bg='#99ccff')
...
def fatcalculator():
    ...
    credit = tk.Label(foot, text="Made by :Abhishek Mohanty",
                      font=("bebas", 6), bg='#99ccff')
    credit.place(relx=0.75, rely=0.93, relwidth=0.3, relheight=0.1)
